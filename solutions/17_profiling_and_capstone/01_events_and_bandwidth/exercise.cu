// Solution -- 17.01 Events and bandwidth
...
// Best of N. The minimum is the least-disturbed run and the number a profiler
// will agree with; a mean would smuggle the warm-up and every interruption
// back in. One un-timed call first: the first launch of a kernel pays for
// loading its code onto the device.
template <typename F>
